...
import { StorageService } from '../../../shared/services/adminService/treatmentsAdmin/storage.service'
...
export class PhysiotherapyComponent implements OnInit {
  constructor(private storageService:StorageService,private treatmentsAdminService: TreatmentsAdminService,private firestore: Firestore) {}
